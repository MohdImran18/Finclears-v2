...
|--------------------------------------------------------------------------
        ...
        */
        ...
        Route::get('/leave-applications', [
            ...
            'index',
        ])->middleware('require_permission:leave.view');

        Route::post('/leave-applications', [
            LeaveApplicationController::class,
            'store',
        ])->middleware('require_permission:leave.request');

        Route::post('/leave-applications/{id}/approve', [
            LeaveApplicationController::class,
            'approve',
        ])->middleware('require_permission:leave.approve');

        Route::post('/leave-applications/{id}/reject', [
            LeaveApplicationController::class,
            'reject',
        ])->middleware('require_permission:leave.reject');

        Route::post('/leave-applications/{id}/cancel', [
            LeaveApplicationController::class,
            'cancel',
        ])->middleware('require_permission:leave.cancel');
        ...
        Route::get('/attendances', [
            ...
            'index',
        ])->middleware('require_permission:attendance.view');
        ...
        Route::post('/attendances/mark-status', [
            AttendanceController::class,
            'markStatus',
        ])->middleware('require_permission:attendance.manage');
        Route::post('/attendances/check-in', [
            AttendanceController::class,
            'checkIn',
        ])->middleware('require_permission:attendance.request');
    ...
    ->only([
        ...
        */
        ...
        Route::get('users', [UserController::class, 'index'])
            ->middleware('require_permission:users.view');

        Route::post('users', [UserController::class, 'store'])
            ->middleware('require_permission:users.create');

        Route::get('users/{user}', [UserController::class, 'show'])
            ->middleware('require_permission:users.view');

        Route::put('users/{user}', [UserController::class, 'update'])
            ->middleware('require_permission:users.edit');

        Route::patch('users/{user}', [UserController::class, 'update'])
            ->middleware('require_permission:users.edit');

        Route::delete('users/{user}', [UserController::class, 'destroy'])
            ->middleware('require_permission:users.manage');
