...
class AttendanceController extends Controller
{
    ...
    public function checkIn(Request $request): JsonResponse
    {
        ...
        if (! $employee) {
            return response()->json([
                'success' => false,
                'message' => 'You are not allowed to check in attendance for this employee.',
            ], 403);
        }
    ...
    public function checkOut(Request $request): JsonResponse
    {
        ...
        if (! $employee) {
            return response()->json([
                'success' => false,
                'message' => 'You are not allowed to check out attendance for this employee.',
            ], 403);
        }
    ...
    public function employeeAttendance(
        ...
        if (! $employee) {
            return response()->json([
                'success' => false,
                'message' => 'You are not allowed to view attendance for this employee.',
            ], 403);
        }
    ...
    /**
     * Mark employee attendance status.
     */
    public function markStatus(Request $request): JsonResponse
    {
        $validated = $request->validate([
            ...
            'status' => [
                'required',
                'in:absent,half_day,leave,holiday,week_off',
            ],
            'shift_id' => [
                'nullable',
                'integer',
        ...
        if (! $employee) {
            return response()->json([
                'success' => false,
                'message' => 'You are not allowed to update attendance for this employee.',
            ], 403);
        }
