...
/**
    ...
    public function index(Request $request): JsonResponse
    {
        ...
        if ($request->user()->role !== \App\Models\User::ROLE_ADMIN) {
            $allowedEmployeeUserIds = $this->employeeAccessScope
                ->getTeamUserIds($request->user()->id);

            $query->whereHas('employeeProfile', function ($employeeQuery) use ($allowedEmployeeUserIds) {
                $employeeQuery->whereIn('user_id', $allowedEmployeeUserIds);
            });
        }
    ...
    public function show(
        ...
        $employeeProfile = $employeeSalaryStructure->employeeProfile;
        ...
        abort_unless(
            ...
            403,
            'You are not allowed to access this salary structure.'
        );
    ...
    public function store(Request $request): JsonResponse
    {
        abort_unless(
            $request->user()->role === \App\Models\User::ROLE_ADMIN,
            403,
            'You are not allowed to create employee salary structures.'
        );
    ...
    public function update(
        ...
        abort_unless(
            $request->user()->role === \App\Models\User::ROLE_ADMIN,
            403,
            'You are not allowed to update employee salary structures.'
        );
    ...
    public function destroy(
        ...
        abort_unless(
            $request->user()->role === \App\Models\User::ROLE_ADMIN,
            403,
            'You are not allowed to delete employee salary structures.'
        );
    ...
    public function setCurrent(
        ...
        abort_unless(
            $request->user()->role === \App\Models\User::ROLE_ADMIN,
            403,
            'You are not allowed to change the current salary structure.'
        );
