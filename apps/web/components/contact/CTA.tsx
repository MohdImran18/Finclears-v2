				...
				<div className="mx-auto max-w-6xl rounded-[36px] bg-white/10 p-14 backdrop-blur-xl">
					<div className="text-center">
						...
						<p className="mx-auto mt-6 max-w-3xl text-xl leading-9 text-blue-100">
							Whether you need Company Registration, GST Registration,
							Trademark, Income Tax, ROC Compliance or Accounting, our experts
							are ready to help.
						</p>
					</div>
					...
					<div className="mt-14 grid gap-6 md:grid-cols-3">
						...
						>
							...
							<p className="mt-3 text-gray-600">Talk to our experts today.</p>
						</Link>
						...
						>
							...
							<h3 className="mt-5 text-2xl font-bold">WhatsApp Us</h3>

							<p className="mt-3">Get an instant response.</p>
						</Link>
						...
						>
							...
							<p className="mt-3 text-gray-600">support@finclears.com</p>
						</Link>
					</div>
