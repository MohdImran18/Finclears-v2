			...
			<div className="container mx-auto px-6">
				<div className="mx-auto mb-14 max-w-3xl text-center">
					...
					<p className="mt-6 text-lg leading-8 text-gray-600">
						Reach out through any of the following channels. Our team will get
					...
					{contactInfo.map((item) => (
						...
						>
							...
							{item.href ? (
								...
								<p className="mt-4 text-gray-600">{item.value}</p>
							)}
						</div>
					))}
				</div>
				...
				<div className="mt-20 rounded-3xl bg-white p-10 shadow-lg">
					<div className="flex flex-col items-center justify-between gap-8 lg:flex-row">
						<div>
							<h3 className="text-3xl font-bold">Connect With FinClears</h3>

							<p className="mt-3 text-gray-600">
								Follow us on social media for updates, business tips and
								compliance news.
							</p>
						</div>
