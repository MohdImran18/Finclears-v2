...
export default function Newsletter() {
	...
	async function onSubmit(values: NewsletterInput) {
		try {
			await newsletter.mutateAsync(values.email);
				...
				<div className="overflow-hidden rounded-[36px] bg-gradient-to-r from-blue-700 via-blue-600 to-indigo-700 p-14 shadow-2xl">
					<div className="mx-auto max-w-4xl text-center">
						...
						<p className="mx-auto mt-6 max-w-3xl text-xl leading-9 text-blue-100">
							Receive expert articles on Company Registration, GST, Trademark,
							Income Tax, Compliance and Startup Growth directly in your inbox.
						</p>
						...
						>
							...
							>
								{newsletter.isPending ? "Subscribing..." : "Subscribe"}
							</button>
						</form>
