			...
			<div className="overflow-hidden rounded-[36px] border border-gray-200 bg-white shadow-xl">
				<div className="grid gap-10 p-10 lg:grid-cols-[220px_1fr]">
					...
					<div>
						...
						<h2 className="mt-6 text-4xl font-bold text-gray-900">{name}</h2>

						<p className="mt-2 text-lg font-medium text-blue-600">{role}</p>

						<p className="mt-6 leading-8 text-gray-600">{bio}</p>
						...
						<div className="mt-8 grid gap-6 md:grid-cols-2">
							<div className="rounded-2xl bg-slate-50 p-6">
								...
								<p className="mt-2 text-gray-600">Published Articles</p>
							</div>

							<div className="rounded-2xl bg-slate-50 p-6">
								<h3 className="text-3xl font-bold text-green-600">Expert</h3>

								<p className="mt-2 text-gray-600">Business Compliance</p>
							</div>
						</div>
