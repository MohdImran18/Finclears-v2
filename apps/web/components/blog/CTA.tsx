				...
				<div className="mx-auto max-w-6xl rounded-[36px] bg-white/10 p-14 backdrop-blur-xl">
					<div className="text-center">
						...
						<p className="mx-auto mt-6 max-w-3xl text-xl leading-9 text-blue-100">
							From Company Registration to GST, Trademark, Accounting and
							Compliance, our experts are here to help your business succeed.
						</p>
					</div>
					...
					<div className="mt-16 grid gap-6 md:grid-cols-4">
						...
						<div className="rounded-2xl bg-white/10 p-6 text-center">
							...
							<h3 className="mt-4 text-xl font-bold text-white">Trademark</h3>
						</div>

						<div className="rounded-2xl bg-white/10 p-6 text-center">
							<div className="text-5xl">⚖️</div>

							<h3 className="mt-4 text-xl font-bold text-white">Compliance</h3>
						</div>
					</div>
					...
					<div className="mt-16 grid gap-8 border-t border-white/20 pt-10 md:grid-cols-4">
						...
						<div className="text-center">
							...
							<p className="mt-2 text-blue-100">Expert Articles</p>
						</div>
