		...
		<section className="bg-slate-50 pb-20">
			...
			<div className="container mx-auto px-6 pt-14">
				<div className="mx-auto max-w-5xl">
					...
					<p className="mt-8 text-xl leading-9 text-gray-600">{excerpt}</p>
					...
					<div className="mt-10 flex flex-wrap items-center gap-8 rounded-2xl bg-white p-6 shadow-md">
						...
						<div className="text-sm text-gray-500">
							📅 Published
							<div className="font-medium text-gray-800">{publishedAt}</div>
						</div>
						...
						<div className="text-sm text-gray-500">
							⏱ Reading Time
							<div className="font-medium text-gray-800">{readingTime}</div>
						</div>
					</div>
