			...
			<div className="overflow-hidden rounded-[40px] bg-gradient-to-r from-blue-700 via-blue-600 to-indigo-700 p-14 text-white shadow-2xl">
				<div className="mx-auto max-w-5xl text-center">
					...
					<p className="mx-auto mt-8 max-w-3xl text-xl leading-9 text-blue-100">
						Whether you're starting a new company, registering GST, filing
						Income Tax, protecting your trademark or managing annual compliance,
					...
					<div className="mt-16 grid gap-6 md:grid-cols-4">
						<div className="rounded-2xl bg-white/10 p-6">
							...
							<h3 className="mt-4 text-lg font-bold">Company Registration</h3>
						</div>

						<div className="rounded-2xl bg-white/10 p-6">
							<div className="text-5xl">📄</div>

							<h3 className="mt-4 text-lg font-bold">GST & Tax Filing</h3>
						</div>

						<div className="rounded-2xl bg-white/10 p-6">
							<div className="text-5xl">™️</div>

							<h3 className="mt-4 text-lg font-bold">Trademark Services</h3>
						</div>

						<div className="rounded-2xl bg-white/10 p-6">
							<div className="text-5xl">⚖️</div>

							<h3 className="mt-4 text-lg font-bold">Annual Compliance</h3>
						</div>
					</div>
					...
					<div className="mt-16 grid gap-8 border-t border-white/20 pt-10 md:grid-cols-4">
						<div>
							...
							<p className="mt-2 text-blue-100">Happy Businesses</p>
						</div>
						...
						<div>
							...
							<p className="mt-2 text-blue-100">Expert Support</p>
						</div>

						<div>
							<h3 className="text-4xl font-bold">PAN India</h3>

							<p className="mt-2 text-blue-100">Business Services</p>
						</div>
					</div>
				</div>
			</div>
