...
export default function BlogCard({
	...
	const imageUrl = featured_image || "/images/blog-placeholder.webp";

	const publishedDate = new Date(created_at).toLocaleDateString("en-IN", {
		day: "numeric",
		month: "short",
		year: "numeric",
	});
	...
	return (
		<article className="group overflow-hidden rounded-[32px] border border-gray-200 bg-white shadow-sm transition duration-300 hover:-translate-y-2 hover:shadow-2xl">
			...
			<div className="p-8">
				...
				<p className="mt-5 line-clamp-3 leading-8 text-gray-600">{excerpt}</p>
