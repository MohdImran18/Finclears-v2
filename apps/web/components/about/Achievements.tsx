			...
			<div className="container mx-auto px-6">
				...
				<div className="mt-20 rounded-[36px] bg-gradient-to-r from-blue-700 via-blue-600 to-indigo-700 p-12 text-white shadow-2xl">
					<div className="grid gap-10 lg:grid-cols-3">
						<div>
							<h3 className="text-4xl font-bold">Trusted Nationwide</h3>

							<p className="mt-5 leading-8 text-blue-100">
								Entrepreneurs, startups, MSMEs and enterprises across India rely
								on FinClears for registrations, taxation and compliance.
							</p>
						</div>

						<div>
							<h3 className="text-4xl font-bold">Expert Team</h3>
						...
						<div>
							<h3 className="text-4xl font-bold">Future Ready</h3>
