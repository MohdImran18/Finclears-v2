				...
				<div className="mx-auto max-w-5xl rounded-[36px] bg-white/10 p-14 backdrop-blur-xl">
					<div className="text-center">
						...
						<p className="mx-auto mt-6 max-w-3xl text-xl leading-9 text-blue-100">
							...
							Company, obtaining GST registration, protecting your brand with a
							trademark, or managing annual compliance, FinClears is here to
					...
					<div className="mt-16 grid gap-8 border-t border-white/20 pt-10 md:grid-cols-4">
						...
						<div className="text-center">
							<h3 className="text-4xl font-bold text-white">PAN</h3>

							<p className="mt-2 text-blue-100">India Service</p>
						</div>
