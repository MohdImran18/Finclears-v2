			...
			<div className="container mx-auto px-6">
				<div className="mx-auto mb-16 max-w-3xl text-center">
					...
					<h2 className="mt-4 text-5xl font-bold text-gray-900">
						Building India's Most Trusted Business Compliance Platform
					</h2>

					<p className="mt-6 text-lg leading-8 text-gray-600">
						We believe every entrepreneur deserves affordable, transparent and
						technology-driven legal and compliance services.
					</p>
				</div>
				...
				<div className="grid gap-10 lg:grid-cols-2">
					...
					<div className="rounded-[32px] bg-white p-10 shadow-lg transition duration-300 hover:-translate-y-2 hover:shadow-2xl">
						...
						<p className="mt-6 text-lg leading-8 text-gray-600">
							To simplify company registration, taxation, accounting and legal
							compliance through innovative technology and expert guidance,
							enabling businesses to focus on growth instead of paperwork.
						</p>
					...
					<div className="rounded-[32px] bg-gradient-to-br from-blue-700 via-blue-600 to-indigo-700 p-10 text-white shadow-lg transition duration-300 hover:-translate-y-2 hover:shadow-2xl">
						...
						<p className="mt-6 text-lg leading-8 text-blue-100">
							To become India's leading digital business services platform,
							empowering millions of entrepreneurs with fast, transparent and
							reliable registration, taxation and compliance solutions.
						</p>
