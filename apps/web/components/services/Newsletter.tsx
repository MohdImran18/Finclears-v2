				...
				<div className="mx-auto max-w-5xl overflow-hidden rounded-3xl bg-white p-10 shadow-xl md:p-16">
					<div className="text-center">
						<div className="mx-auto flex h-20 w-20 items-center justify-center rounded-full bg-blue-100">
							<Mail size={38} className="text-blue-600" />
						</div>
						...
						<p className="mx-auto mt-6 max-w-3xl text-lg leading-8 text-slate-600">
							Subscribe to receive the latest updates on Company Registration,
							GST, Trademark, ROC Compliance, Income Tax and other business
							services.
						</p>
					</div>
					...
					<div className="mt-14 grid gap-8 text-center md:grid-cols-3">
						<div>
							<h3 className="text-3xl font-bold text-blue-600">Weekly</h3>

							<p className="mt-2 text-slate-600">Business Updates</p>
						</div>

						<div>
							<h3 className="text-3xl font-bold text-blue-600">100+</h3>

							<p className="mt-2 text-slate-600">Expert Articles</p>
						</div>

						<div>
							<h3 className="text-3xl font-bold text-blue-600">Free</h3>

							<p className="mt-2 text-slate-600">Compliance Tips</p>
						</div>
					</div>
				</div>
			</div>
