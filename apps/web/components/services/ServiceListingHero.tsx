			...
			<div className="relative mx-auto flex max-w-7xl flex-col items-center gap-14 px-6 py-24 lg:flex-row">
				...
				<div className="flex-1">
					...
					<p className="mt-6 max-w-2xl text-lg leading-8 text-blue-100">
						Register your company, GST, Trademark, ROC, Income Tax and
						Compliance services with India's trusted legal experts.
					</p>
				...
				<div className="flex-1">
					<div className="grid grid-cols-2 gap-5">
						<div className="rounded-3xl bg-white/10 p-8 backdrop-blur">
							...
							<p className="mt-2 text-blue-100">Businesses Registered</p>
						</div>
						...
						<div className="rounded-3xl bg-white/10 p-8 backdrop-blur">
							...
							<p className="mt-2 text-blue-100">Secure Online Process</p>
						</div>
						...
						<div className="rounded-3xl bg-white/10 p-8 backdrop-blur">
							...
							<p className="mt-2 text-blue-100">Expert CAs & CS</p>
						</div>
						...
						<div className="rounded-3xl bg-white/10 p-8 backdrop-blur">
							...
							<p className="mt-2 text-blue-100">Customer Rating</p>
						</div>
					</div>
				</div>
			</div>
