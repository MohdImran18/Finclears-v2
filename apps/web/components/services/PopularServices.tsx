	...
	return (
		<section className="bg-white py-20">
			<div className="container mx-auto px-6">
				<div className="mb-14 flex flex-col items-center justify-between gap-6 lg:flex-row">
					<div>
						...
						<p className="mt-4 max-w-2xl text-lg leading-8 text-slate-600">
							Explore the most frequently selected business registration, GST,
							trademark, taxation and compliance services trusted by startups
				...
				<ServiceGrid services={popularServices} loading={loading} />
			</div>
		</section>
	);
}
