	...
	return (
		<section className="bg-slate-50 py-14">
			<div className="container mx-auto px-6">
				<div className="mb-14 flex flex-col items-center justify-between gap-6 lg:flex-row">
					<div>
						...
						<p className="mt-4 max-w-2xl text-lg leading-8 text-slate-600">
							Discover our most trusted registration, compliance and taxation
							services chosen by thousands of startups, MSMEs and growing
				...
				<ServiceGrid services={featuredServices} loading={loading} />
			</div>
		</section>
	);
}
