...
import { BriefcaseBusiness, Building2, ShieldCheck, Star } from "lucide-react";
...
const stats: Stat[] = [
	{
		...
		description: "Helping startups, MSMEs and enterprises across India.",
		icon: Building2,
	},
	{
		id: 2,
		value: "500+",
		title: "Expert CAs & CS",
		description: "Dedicated professionals for every business requirement.",
	...
	},
	{
		...
		description: "Trusted by thousands of happy business owners.",
		icon: Star,
	},
	{
		id: 4,
		value: "100%",
		title: "Secure & Online",
		description: "Completely digital, secure and transparent process.",
		icon: ShieldCheck,
	},
];
			...
			<div className="container mx-auto px-6">
				<div className="mb-14 text-center">
					...
					<p className="mx-auto mt-5 max-w-3xl text-lg leading-8 text-slate-600">
						We simplify company registration, GST, trademark, tax and compliance
