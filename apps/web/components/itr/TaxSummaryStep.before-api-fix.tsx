    ...
    const fetchTax = useCallback(async () => {
        ...
        try {
            ...
            const payload = {
                ...
                taxable_income:
                    income.grossIncome - deductions.total,
            };

            const response = (await itrService.calculate(
                uuid,
                payload
            )) as TaxResponse;
    ...
    const rows = [
        {
            ...
            value: formatCurrency(summary.gross_total_income),
        },
        {
        ...
        {
            label: "Basic Tax",
            value: formatCurrency(summary.basic_tax),
        },
        {
            label: "Rebate",
            value: formatCurrency(summary.rebate),
        },
        {
            label: "Health & Education Cess",
            value: formatCurrency(summary.cess),
        },
        {
            label: "Surcharge",
            value: formatCurrency(summary.surcharge),
        },
        {
            label: "Net Tax Payable",
            value: formatCurrency(summary.net_tax_payable),
        },
    ];
        ...
        <div className="space-y-6">
            <div>
                ...
                <p className="mt-2 text-slate-500">
                    Review your calculated tax before submission.
                </p>
            </div>
