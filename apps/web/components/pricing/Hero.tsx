			...
			<div className="container relative mx-auto px-6 py-24">
				<div className="mx-auto max-w-4xl text-center">
					...
					<h1 className="mt-8 text-5xl font-extrabold leading-tight text-white lg:text-6xl">
						Simple Pricing
						<span className="block text-yellow-300">For Every Business</span>
					</h1>

					<p className="mx-auto mt-8 max-w-3xl text-xl leading-9 text-blue-100">
						No hidden charges. Professional CA support. Government filing
						included. Choose the plan that fits your business.
					</p>
