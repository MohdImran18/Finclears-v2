			...
			<div className="container mx-auto px-6">
				<div className="mx-auto mb-14 max-w-3xl text-center">
					...
					<p className="mt-5 text-lg text-gray-600">
						We help entrepreneurs, startups, MSMEs and enterprises with
						registrations, taxation and compliance.
					</p>
				</div>
				...
				<div className="mt-16 grid gap-8 md:grid-cols-3">
					<div className="rounded-3xl bg-white p-8 text-center shadow-sm">
						...
						<p className="mt-3 text-gray-600">Businesses Registered</p>
					</div>

					<div className="rounded-3xl bg-white p-8 text-center shadow-sm">
						<h3 className="text-5xl font-bold text-green-600">99%</h3>
					...
					<div className="rounded-3xl bg-white p-8 text-center shadow-sm">
						...
						<p className="mt-3 text-gray-600">Expert Support</p>
					</div>
				</div>
			</div>
		</section>
