			...
			<Container>
				<div className="flex h-16 items-center justify-between">
					...
					<Link href="/" className="flex items-center gap-3">
						...
						<div>
							<h2 className="text-xl font-bold text-slate-900">FinClears</h2>

							<p className="text-xs text-slate-500">Business Simplified</p>
						</div>
					</Link>
					...
					<div className="hidden items-center gap-3 lg:flex">
						...
						<Link href="/contact">
							<Button variant="gradient">Free Consultation</Button>
						</Link>
					</div>
			...
			>
				...
				>
					<div className="flex items-center justify-between border-b p-6">
						<h2 className="text-xl font-bold">FinClears</h2>
