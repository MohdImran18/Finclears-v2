				...
				<div className="grid gap-16 py-24 lg:grid-cols-4">
					...
					<div>
						<div className="flex items-center gap-3">
							...
							<div>
								<div className="text-2xl font-bold">FinClears</div>
						...
						<p className="mt-8 leading-8 text-slate-400">
							India's trusted online platform for Company Registration, GST,
							Trademark, Income Tax, ROC Compliance and Legal Services.
						</p>
						...
						<div className="mt-8 space-y-4">
							<div className="flex items-center gap-3">
								...
								<a href="tel:+919873247695">+91 9873247695</a>
							</div>

							<div className="flex items-center gap-3">
								<Mail size={18} className="text-blue-400" />

								<a href="mailto:info@finclears.com">info@finclears.com</a>
							</div>
					...
					<div>
						...
						<p className="mt-6 leading-7 text-slate-400">
							Subscribe for business tips, tax updates and startup news.
						</p>
				...
				<div className="border-t border-slate-800 py-8">
					<div className="flex flex-col items-center justify-between gap-6 lg:flex-row">
						<div className="text-slate-400">
							© {new Date().getFullYear()} FinClears. All Rights Reserved.
						</div>
