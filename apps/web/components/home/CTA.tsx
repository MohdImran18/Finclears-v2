					...
					<div className="grid items-center gap-12 lg:grid-cols-2">
						...
						<div>
							...
							<p className="mt-6 text-lg leading-8 text-blue-100">
								Whether you're starting a Private Limited Company, LLP, GST
								Registration, Trademark, or Annual Compliance, FinClears is here
								to simplify every step.
							</p>
						...
						<div className="rounded-3xl bg-white p-8 shadow-2xl">
							...
							<div className="mt-8 space-y-5">
								...
								<div className="flex items-center gap-4">
									...
									<span className="text-gray-700">Expert CA & CS Team</span>
								</div>
								...
								<div className="flex items-center gap-4">
									...
									<span className="text-gray-700">Fast Government Filing</span>
								</div>
							...
							<div className="mt-10 grid grid-cols-3 gap-6 border-t pt-8">
								...
								<div className="text-center">
									<h4 className="text-3xl font-bold text-orange-600">24×7</h4>
