			...
			<div className="container mx-auto px-6">
				<div className="mb-14 text-center">
					...
					<p className="mx-auto mt-4 max-w-3xl text-lg text-gray-600">
						From startup registration to annual compliance, FinClears has helped
						businesses across India grow confidently.
					</p>
				</div>
				...
				<div className="grid gap-8 md:grid-cols-2 xl:grid-cols-4">
					{stats.map((item) => (
						...
						>
							<h3 className={`text-5xl font-extrabold ${item.color}`}>
								{item.value}
							</h3>
