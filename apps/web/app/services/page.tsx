...
export default function ServicesPage() {
	...
	const filteredServices = useMemo(() => {
		return services.filter((service: Service) => {
			...
			const matchesSearch =
				...
				(service.short_description ?? "").toLowerCase().includes(search.toLowerCase());
	...
	if (isError) {
		return (
			<main className="container mx-auto px-6 py-24 text-center">
				<h2 className="text-3xl font-bold">Unable to load services</h2>

				<p className="mt-4 text-slate-500">Please try again later.</p>
			</main>
		);
	}
	...
	return (
		<main>
			...
			<FeaturedServices services={services} loading={isLoading} />
				...
				faqs={[
					{
						...
						answer:
							"Most company registrations are completed within 5â€“10 working days depending on document verification and government approval.",
					},
					{
