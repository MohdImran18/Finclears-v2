			...
			<div className="grid gap-8 lg:grid-cols-3">
				...
				<div className="space-y-6 lg:col-span-1">
					<div className="rounded-2xl border bg-white p-6 shadow-sm">
						<h2 className="mb-6 text-xl font-semibold">Document Information</h2>
						<div className="space-y-5">
							...
							<div className="flex items-center gap-3">
								...
								<div>
									...
									<p className="font-medium">{document.company_id}</p>
								</div>
							</div>
							...
							{document.order_id && (
								<div className="flex items-center gap-3">
									...
									<div>
										...
										<p className="font-medium">{document.order_id}</p>
									</div>
								</div>
							)}
							...
							{document.remarks && (
								<div>
									<p className="mb-2 text-sm text-slate-500">Remarks</p>
				...
				<div className="space-y-6 lg:col-span-2">
					...
					<div className="rounded-2xl border bg-white p-6 shadow-sm">
						<h2 className="mb-6 text-xl font-semibold">File Details</h2>
						...
						<div className="grid gap-6 md:grid-cols-2">
							...
							<div>
								...
								<p className="font-medium uppercase">{document.extension}</p>
							</div>
