		...
		<div className="mx-auto max-w-4xl">
			<div className="mb-8">
				...
				<p className="mt-2 text-slate-500">
					Upload documents for your company or order.
				</p>
			</div>
			...
			>
				<div>
					<label className="mb-2 block font-medium">Document Title</label>
				...
				<div>
					<label className="mb-2 block font-medium">Document Type</label>
				...
				<div className="grid gap-6 md:grid-cols-2">
					<div>
						<label className="mb-2 block font-medium">Company ID</label>
					...
					<div>
						<label className="mb-2 block font-medium">Order ID</label>

						<input
							type="number"
							value={orderId ?? ""}
							onChange={(e) =>
								setOrderId(e.target.value ? Number(e.target.value) : undefined)
							}
							className="w-full rounded-xl border px-4 py-3"
						/>
					</div>
				...
				<div>
					<label className="mb-2 block font-medium">Upload Document</label>
