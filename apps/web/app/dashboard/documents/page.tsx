		...
		<div className="space-y-8">
			...
			<div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
				<div>
					...
					<p className="mt-2 text-slate-500">
						Upload, manage and track all documents submitted for your services.
					</p>
				</div>
			...
			<div className="grid gap-6 md:grid-cols-4">
				<div className="rounded-2xl border bg-white p-6">
					...
					<h2 className="mt-3 text-3xl font-bold">{documents.length}</h2>
				</div>
			...
			{isError && (
				<div className="rounded-2xl border border-red-200 bg-red-50 p-8 text-center">
					<p className="font-medium text-red-600">Unable to load documents.</p>
			...
			{!isLoading && !isError && documents.length === 0 && (
				<div className="rounded-2xl border border-dashed bg-white py-20 text-center">
					...
					<h2 className="mt-6 text-2xl font-bold">No Documents Uploaded</h2>

					<p className="mt-3 text-slate-500">
						Upload your first document to begin your registration or compliance
						process.
					</p>
