...
function statusClass(status: AttendanceStatus) {
  switch (status) {
    case "present":
      return "attendanceStatus attendanceStatusPresent";
    case "absent":
      return "attendanceStatus attendanceStatusAbsent";
    case "half_day":
      return "attendanceStatus attendanceStatusHalfDay";
    case "leave":
      return "attendanceStatus attendanceStatusLeave";
    case "holiday":
      return "attendanceStatus attendanceStatusHoliday";
    case "week_off":
      return "attendanceStatus attendanceStatusWeekOff";
    default:
  ...
  async function loadAttendance() {
    try {
      ...
      const response = await getAttendances({
        employee_profile_id: filterEmployeeId
