      ...
      <div className="editContainer">
        ...
        >
          ...
          <div className="formGrid">
            ...
            <Field
              icon={<span className="currencyIcon">₹</span>}
              label="Customer Value"
              type="number"
              value={form.total_value}
              onChange={(v) =>
                update("total_value", v)
              }
              placeholder="0"
            />
          ...
          <div className="notesSection">
            ...
            <textarea
              ...
              placeholder="Add important customer notes..."
              rows={5}
            />

            <span>
              Optional internal notes for CRM
              management.
            </span>
